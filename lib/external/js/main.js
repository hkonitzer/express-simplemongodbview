  ...
  initialize: function(opts_) {       
    ...
    this.gridOptions = {
        ...
        beforeRequest: function() {
          $('div#'+modelcid).find('.collectionHeaderAjaxLoader').show();          
        },
        loadComplete: function() {
          $('div#'+modelcid).find('.collectionHeaderAjaxLoader').hide();
        }
    }
    var colModelInit = [];
...
var C_indexView = Backbone.View.extend({      
  ...
  setupModel : function(model) {
    ...
    headerElem.append('<div class="collectionHeaderText">Workbench: <span class="modelName">'+model.get('modelName')+'&nbsp;</span>(<span class="modelCount"></span>)</div>')
